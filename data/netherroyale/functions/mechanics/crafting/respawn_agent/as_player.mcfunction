...
execute if score @s nr.craft_star matches 1.. if data entity @s {"Inventory":[{"id":"minecraft:creeper_spawn_egg"}]} run function netherroyale:mechanics/crafting/respawn_agent/craft
